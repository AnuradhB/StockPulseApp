...
import com.example.stockpulseapp.presentation.auth.data.api.UiState
...
@Composable
fun LoginScreen(
    onSuccess: () -> Unit, viewModel: AuthViewModel = hiltViewModel()
) {
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.ic_launcher_background), modifier = Modifier.size(120.dp),
        ...
        Text(
            ...
            fontFamily = fontF,
            modifier = Modifier.clearAndSetSemantics { }, // 👈 ignore in testing
        ...
        Text(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .clearAndSetSemantics { }, // 👈 ignore in testing
        ...
        Button(
            ...
            Text(
                "Login", fontSize = 16.sp,   // 👈 ignore in testing
...
@Composable
fun ObserverMth(state: UiState<User>) {
    when (state) {
